...
export function normalizeConfig(defaultConfig, config) {
  ...
  if (Array.isArray(defaultConfig.PALETTE) || Array.isArray(merged.PALETTE)) {
    const defaultPalette = Array.isArray(defaultConfig.PALETTE) ? deepClone(defaultConfig.PALETTE) : [];
